    ...
    t.exports = function(t, e, o) {
      ...
      if (i)
        (l = n(t.substr(1, 2))),
          (e = n(t.substr(3, 2))),
          (o = n(t.substr(5, 2)));
      else if (r) (l = parseInt(t)), (e = parseInt(e)), (o = parseInt(o));
      else {
        if (!a) return s;
        (l = parseInt(t[0])), (e = parseInt(t[1])), (o = parseInt(t[2]));
      }
      return (
        Math.sqrt(l * l * 0.241 + e * e * 0.691 + o * o * 0.068) > 130 &&
          (s = "#000000"),
        s
      );
    };
          ...
          },
          {
            ...
            value: function() {
              ...
              for (
                ...
                var n = parseInt(t[e].style.marginTop);
                t[e].style.marginTop = "".concat(n - this.height, "px");
              }
            }
          },
          {
